...
allowed_errors = [ERROR_GA_SCHEDULE]
...
illegal_errors = [ERROR_ERROR_LOG, ERROR_MULTIPLE_WORKERS, ERROR_GA_SOLUTION, ERROR_GA_OUTPUT, ERROR_SIMULATOR_TOPOLOGY, ERROR_SIMULATOR_TOPOLOGY_OUTPUT, ERROR_FAILED_EXPERIMENT, ERROR_VISUALIZATION_FILE, ERROR_GA_INVALID_SOLUTION]
...
def validate_dir(exp_dir):
    ...
    visualization_output = '%s/visualization-ga.html' % exp_dir  # should be there
