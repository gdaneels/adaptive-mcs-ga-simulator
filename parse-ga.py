...
def ga_calculate_modulation_count(ind, datafile_dir):
    ...
    with open(simulator_topology_path) as json_file:
        simulator_topology = json.load(json_file)
    # get the list of modulations
    MCSs = simulator_topology["modulations"]

    dict_MCSs = {k: 0 for v, k in enumerate(MCSs)}
    print('dict_MCSs ', dict_MCSs)
...
if __name__ == '__main__':
    ...
    result_types = ['ga-slotbonding', 'ga-evolution', 'exhaustive-compare', 'heuristic-compare', 'modulation-analysis']
    ...
    for experimentType in experimentTypes:
        ...
        if result_type == 'ga-slotbonding' or result_type == 'ga-exhaustive' or result_type == 'exhaustive-compare' or result_type == 'heuristic-compare':
